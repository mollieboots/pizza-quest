...
import { doAttack } from "./../src/battle.js";
describe("Player", () => {
  ...
  //     let monster = new Monster("Jimbo", 1, false, 10, 5, 10, 1);
  //     let player = new Player("Benny", "Mechanic", true, 25);
  //     expect(player.doDamage(monster)).toBeGreaterThanOrEqual(1);
  //     expect(player.doDamage(monster)).toBeLessThan(7);
  //   });
  //   test("should rolldice and add players horsepower and return a message on a fail", () => {
  //     let monster = new Monster("Jimbo", 30, false, 30, 5, 10, 1);
  //     let player = new Player("Benny", "Mechanic", true, 25);
  //     expect(player.doDamage(monster)).toEqual("You missed!");
  //   });
  ...
  //     let monster = new Monster("Jimbo", 1, true, 30, 5, 30, 1);
  //     let player = new Player("Benny", "Cheerleader");
  //     expect(player.throwPizza(monster)).toEqual(
  ...
  test("should change monster health", () => {
    ...
    let monster = new Monster("Jimbo", 1, false, 100, 5, 30, 1);
    doAttack(monster);
